...
void setup() {
  ...
  Serial.println("1. Done with one frame");
  Serial.println("2. Done with whole process, return to origin");
  Serial.println();
}
...
void ReverseStepDefault()
{
  ...
  for(x= 1; x<350; x++)  //Loop the stepping enough times for motion to be visible
  {
